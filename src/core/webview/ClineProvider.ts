...
export class ClineProvider implements vscode.WebviewViewProvider {
	public static readonly sideBarId = "cline-max.SidebarProvider" // used in package.json as the view's id. This value cannot be changed due to how vscode caches views based on their id, and updating the id would break existing instances of the extension.
	public static readonly tabPanelId = "cline-max.TabPanelProvider"
				...
				switch (message.type) {
					...
					case "openExtensionSettings": {
						...
						await vscode.commands.executeCommand(
							...
							`@ext:maximumcomputeinc.cline-max ${settingsFilter}`.trim(), // trim whitespace if no settings filter
						)
						break
					}
